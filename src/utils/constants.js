export const weatherOptions = [
  // Clear
  {
    day: true,
    condition: "clear",
    url: new URL("../assets/Clear-Day.svg", import.meta.url).href,
  },
  {
    day: false,
    condition: "clear",
    url: new URL("../assets/Clear-Night.svg", import.meta.url).href,
  },
  ...
  // Clouds
  {
    day: true,
    condition: "clouds",
    url: new URL("../assets/Cloudy-Day.svg", import.meta.url).href,
  },
  {
    day: false,
    condition: "clouds",
    url: new URL("../assets/Cloudy-Night.svg", import.meta.url).href,
  },
  ...
  // Fog
  {
    day: true,
    condition: "fog",
    url: new URL("../assets/Foggy-Day.svg", import.meta.url).href,
  },
  {
    day: false,
    condition: "fog",
    url: new URL("../assets/Foggy-Night.svg", import.meta.url).href,
  },
  ...
  // Rain
  {
    day: true,
    condition: "rain",
    url: new URL("../assets/Rainy-Day.svg", import.meta.url).href,
  },
  {
    day: false,
    condition: "rain",
    url: new URL("../assets/Rainy-Night.svg", import.meta.url).href,
  },
  ...
  // Thunderstorm
  {
    ...
    url: new URL("../assets/Stormy-Day.svg", import.meta.url).href,
  },
  {
    day: false,
    condition: "thunderstorm",
    url: new URL("../assets/Stormy-Night.svg", import.meta.url).href,
  },
  ...
  // Snow
  {
    day: true,
    condition: "snow",
    url: new URL("../assets/Snowy-Day.svg", import.meta.url).href,
  },
  {
    day: false,
    condition: "snow",
    url: new URL("../assets/Snowy-Night.svg", import.meta.url).href,
  },
];
...
export const apiKey = "3ca21993b3b09db11b13b47fb9706f2a";
